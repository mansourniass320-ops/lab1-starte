...
const Auth = () => {
  ...
  return (
    <form className={styles.form} onSubmit={soumettre}>
      ...
      <button type="button" onClick={() => setMode(mode === "signup" ? "login" : "signup")} className={styles.basculer}>
        {mode === "signup" ? "Déjà un compte ? Se connecter" : "Pas encore de compte ? Créer"}
      </button>
    </form>
  );
};
